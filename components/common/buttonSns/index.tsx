...
const snsInfo = {
  kakao: {
    ...
    authURL: `https://kauth.kakao.com/oauth/authorize?client_id=${process.env.NEXT_PUBLIC_KAKAO_REST_API_KEY}&redirect_uri=${process.env.NEXT_PUBLIC_KAKAO_REDIRECT_URI}&response_type=code`,
  },
  naver: {
    logo: <NaverLogo />,
  ...
  apple: {
    ...
    authURL: `https://accounts.google.com/o/oauth2/v2/auth?scope=email profile openid&response_type=code&redirect_uri=${process.env.NEXT_PUBLIC_GOOGLE_REDIRECT_URI}&client_id=${process.env.NEXT_PUBLIC_GOOGLE_CLIENT_ID}`,
  },
};

...
import PostEditor from '@/components/createPostFunnel/writePage/postEditor';
import PostImageUploader from '@/components/createPostFunnel/writePage/postImageUploader';
import styles from './index.module.scss';
import PreviewImageContainer from '@/components/createPostFunnel/writePage/previewImageContainer';
import CommnuityRules from '@/components/createPostFunnel/writePage/communityRules';
